<aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
        @if (Auth::check() && Auth::user()->role == 'admin')
            ...
            <li class="{{ Str::startsWith(Request::path(), 'admin') ? 'active' : '' }}"><a class="nav-link" href="/dashboard"><i class="fas fa-home"></i>
                <span>Dashboard Admin</span></a></li>
            <li class="{{ Request::path() == 'manajemen-staff' ? 'active' : '' }}"><a class="nav-link" href="/manajemen-staff"><i class="fas fa-user"></i>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li class="{{ Request::path() == 'tampil_item' ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.tampil_item') }}"><i class="fas fa-cube"></i>
                        <span>Manajemen Item</span></a></li>
                    <li class="{{ Request::path() == 'tampilkategori' ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.tampilkategori') }}"><i class="fas fa-thumbtack"></i>
                        <span>Manajemen kategori</span></a></li>
                </ul>
            </li>
            <!-- End of Dropdown menu -->
            <li class="{{ Request::path() == 'tampil_supplier' ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.tampil_supplier') }}"><i class="far fa-user"></i>
                <span>Manajemen Supplier</span></a></li>
        @endif

        @if (Auth::check() && Auth::user()->role == 'staf')
            <!-- Sidebar menu items for staff -->
            <li class="{{ Request::path() == '/' ? 'active' : '' }}"><a class="nav-link" href="/dashboard"><i class="fas fa-home"></i>

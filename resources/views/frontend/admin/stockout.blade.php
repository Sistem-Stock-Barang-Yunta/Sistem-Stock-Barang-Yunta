                        ...
                        <tbody>
                            @foreach ($Stockouts as $Stockout)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.edit_stockout', $Stockout->id) }}" class="btn btn-sm btn-primary">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <form action="{{ route('admin.hapus_stockout', $Stockout->id) }}" method="POST" style="display:inline-block;">
                                            @csrf
                                            @method('DELETE')
